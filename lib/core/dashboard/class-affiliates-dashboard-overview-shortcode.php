 ...
 */
class Affiliates_Dashboard_Overview_Shortcode extends Affiliates_Dashboard_Overview {

	/**
	 * Initialization - adds the shortcode.
	 */
	public static function init() {
		add_shortcode( 'affiliates_dashboard_overview', array( __CLASS__, 'shortcode' ) );
	}
...
Affiliates_Dashboard_Overview_Shortcode::init();
