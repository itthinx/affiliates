...
class Affiliates_Dashboard_Overview {
	...
	public static function init() {
		add_shortcode( 'affiliates_dashboard_overview', array( __CLASS__, 'affiliates_dashboard_section_shortcode' ) );
	}
	...
	public function render() {
		...
		if ( $this->user_id !== null ) {
			Affiliates_Templates::include_template( 'dashboard/overview.php' );
		}
	}
