...
class Affiliates_Dashboard_Login_Block extends Affiliates_Dashboard_Login {
	...
	public static function wp_init() {
		if ( function_exists( 'register_block_type' ) ) {
			...
			wp_register_script(
				'affiliates-dashboard-blocks',
				plugins_url( 'js/dashboard-blocks.js', AFFILIATES_FILE ),
				array( 'wp-blocks', 'wp-element' )
			);

			wp_localize_script(
				'affiliates-dashboard-blocks',
				'affiliates_dashboard_blocks',
				array(
			...
			// wp_register_style(
			//	'affiliates-dashboard-blocks-editor',
			...
			register_block_type(
				...
				array(
					'editor_script' => 'affiliates-dashboard-blocks',
